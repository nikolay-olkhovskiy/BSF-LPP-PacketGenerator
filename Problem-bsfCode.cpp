	...
	double t) 
{
	...
	cout << "-----------------------------------" << endl;
	FILE* stream_A = fopen(fileName, "w");
	if (stream_A == NULL) {
		cout << "Failure of opening file " << fileName << "!\n";
		return;
	}
	...
	cout << "-----------------------------------" << endl;
	FILE* stream_b = fopen(fileName, "w");
	if (stream_b == NULL) {
		cout << "Failure of opening file " << fileName << "!\n";
		return;
	}
	...
	cout << "-----------------------------------" << endl;
	FILE* stream_c = fopen(fileName, "w");
	if (stream_c == NULL) {
		cout << "Failure of opening file " << fileName << "!\n";
		return;
	}
	...
	cout << "-----------------------------------" << endl;
	FILE* stream_hi = fopen(fileName, "w");
	if (stream_hi == NULL) {
		cout << "Failure of opening file " << fileName << "!\n";
		return;
	}
	...
	cout << "-----------------------------------" << endl;
	FILE* stream_lo = fopen(fileName, "w");
	if (stream_lo == NULL) {
		cout << "Failure of opening file " << fileName << "!\n";
		return;
	}
